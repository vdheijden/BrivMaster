...
{
	static TIMEOUT_BASE:=(IsObject(g_IBM_Settings) && g_IBM_Settings.HasKey("IBM_Casino_Timeout_Base") ? g_IBM_Settings["IBM_Casino_Timeout_Base"] : 100000)  ;Allow 10s at x10 speed, 8s at x12.5
